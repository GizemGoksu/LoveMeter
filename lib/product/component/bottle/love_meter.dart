      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
              left: 3.32,
              bottom: 3.32,
              child: Liquid(percentage: percentage),
          ),
        ],
      ),
    );
    ...
    return SizedBox(
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return Text(
              text,
              style: const TextStyle(color: ColorUtil.white, fontSize: 14,fontWeight: FontWeight.w300),
            );
          },
          separatorBuilder: ((context, index) => const SizedBox(height: 37)),
          ),
    );
  }
